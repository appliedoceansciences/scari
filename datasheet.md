...
As an example, given a sample rate of 31250 sps, an onboard fft length of 4096, and emitting 48 bands per octave: there would be 68 linearly-spaced bins with centers spanning from 15.4 to 526.4 Hz inclusive, followed by 234 log-spaced bins with centers from 534 to 15446 Hz inclusive. The lowest frequency captured by the lowest bin would be about 15.3 Hz. The total number of pixel-encoding bytes would be 302.
